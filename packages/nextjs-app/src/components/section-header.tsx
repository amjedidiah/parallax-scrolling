  ...
  return (
    <header className={className}>
      <div className="container">
        ...
        >
          <span className="text-[6.5rem] sm:text-[8.5rem] text-blue-200 relative after:absolute after:content-[' '] after:w-4 after:h-4 after:bottom-[1.875rem] sm:after:bottom-10 after:-right-[18px] after:bg-blue-200">
            {number}
          </span>
